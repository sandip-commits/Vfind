 ...
 return (
  <div className="min-h-screen bg-gray-100 p-4">
      ...
      >
        <Heart
          className={`w-6 h-6 transition-colors duration-200 ${
            wishlisted ? "text-white" : "text-blue-600"
          }`}
        />
      </button>
        ...
        <div className="flex-1 space-y-2">
          ...
          {(connectionStatus === "rejected" || connectionStatus === "none") && (
            <button
              ...
              className="mt-3 px-6 py-2 rounded-[14px] bg-[#FFFDFD] hover:bg-[#0073FF] hover:text-white text-[#0073FF] border border-blue-400"
            >
      ...
      <div className="flex-1 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-gray-900">
              {candidate.visaType || "Skilled Independent Visa (Subclass 189)"}
            </p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500 mb-1">Duration</h3>
            <p className="text-gray-900">Permanent Residency since 2020</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mt-5 mx-4 mx-auto container">
      ...
      {/* Preferred Shifts */}
      <div className="mb-6">
        <h3 className="font-medium text-gray-700 mb-2">Preferred Shifts</h3>
        <div className="flex flex-wrap gap-2">
          {jobTypesArray.length > 0 ? (
            jobTypesArray.map((shift: string, index: number) => (
              <span
                key={index}
            ...
            <span className="text-gray-400 text-sm italic">No preferred shifts specified</span>
          )}
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div className="space-y-3 text-sm">
          ...
          <div>
            ...
            <p className="font-medium text-gray-900">{candidate.workingInHealthcare}</p>
          </div>
          <div>
